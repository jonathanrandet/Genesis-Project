...
},{"../../lib/views/GenesisView":18}],2:[function(require,module,exports){
module.exports = {
	module_name: {
...
},{"./modules/module_name/config":24,"./modules/module_name/tpl/AddTemplate.hbs":25,"./modules/module_name/tpl/EditTemplate.hbs":26,"./modules/module_name/tpl/ListTemplate.hbs":27,"./modules/module_name/tpl/SearchTemplate.hbs":28}],3:[function(require,module,exports){
...
},{"backbone":29,"jquery":49,"underscore":50}],4:[function(require,module,exports){
...
},{"../models/BlockModel":9,"./BaseCollection":3}],5:[function(require,module,exports){
var BaseCollection = require('./BaseCollection');
...
},{"../models/DataModel":10,"./BaseCollection":3}],6:[function(require,module,exports){
var BaseCollection = require('./BaseCollection');
...
},{"../models/FieldModel":11,"./BaseCollection":3}],7:[function(require,module,exports){
var BaseCollection = require('./BaseCollection');
...
},{"../models/PageModel":13,"./BaseCollection":3}],8:[function(require,module,exports){
var Backbone = require('backbone');
var $ = require('jquery');
var _ = require('underscore');
Backbone.$ = $;
...
},{"backbone":29,"jquery":49,"underscore":50}],9:[function(require,module,exports){
...
function afterInit(){
	console.log('Je suis dans BlockModel');
}
},{"./BaseModel":8,"underscore":50}],10:[function(require,module,exports){
var BaseModel = require('./BaseModel');
var _ = require('underscore');
...
function afterInit(){
	console.log('Je suis dans DataModel');
}
},{"./BaseModel":8,"underscore":50}],11:[function(require,module,exports){
var BaseModel = require('./BaseModel');
...
},{"./BaseModel":8,"underscore":50}],13:[function(require,module,exports){
var BaseModel = require('./BaseModel');
var _ = require('underscore');
...
function afterInit(){
	console.log('Je suis dans PageModel');
}

},{"./BaseModel":8,"underscore":50}],14:[function(require,module,exports){
var Backbone = require('backbone');
var $ = require('jquery');
var _ = require('underscore');
Backbone.$ = $;
...
},{"backbone":29,"jquery":49,"underscore":50}],15:[function(require,module,exports){
...
},{"./BaseView":16,"underscore":50}],16:[function(require,module,exports){
var Backbone = require('backbone');
var $ = require('jquery');
var _ = require('underscore');
...
},{"backbone":29,"handlebars":46,"jquery":49,"underscore":50}],17:[function(require,module,exports){
var BaseView = require('./BaseView');
...
},{"../models/BaseModel":8,"./BaseView":16,"underscore":50}],18:[function(require,module,exports){
var Backbone = require('backbone');
var BaseView = require('./BaseView');
var $ = require('jquery');
Backbone.$ = $; 
...
},{"../../config":2,"../collections/PageCollection":7,"../models/ModuleModel":12,"../routers/Router":14,"./BaseView":16,"./ModuleView":20,"./PageView":21,"backbone":29,"jquery":49,"underscore":50}],19:[function(require,module,exports){
var Backbone = require('backbone');
var BaseView = require('./BaseView');
var _ = require('underscore');
var $ = require('jquery');
...
},{"./BaseView":16,"backbone":29,"jquery":49,"underscore":50}],20:[function(require,module,exports){
var Backbone = require('backbone');
var BaseView = require('./BaseView');
var $ = require('jquery');
Backbone.$ = $; 
...
},{"../collections/DataCollection":5,"../collections/FieldCollection":6,"./AddView":15,"./BaseView":16,"./EditView":17,"./ListView":19,"./SearchView":22,"./StateView":23,"backbone":29,"jquery":49,"underscore":50}],21:[function(require,module,exports){
var Backbone = require('backbone');
...
},{"../collections/BlockCollection":4,"backbone":29,"jquery":49,"underscore":50}],22:[function(require,module,exports){
var BaseView = require('./BaseView');
var _ = require('underscore');
var DataCollection = require('../collections/DataCollection');
...
},{"../collections/DataCollection":5,"./BaseView":16,"underscore":50}],23:[function(require,module,exports){
var BaseView = require('./BaseView');
var _ = require('underscore');
...
},{"./BaseView":16,"underscore":50}],24:[function(require,module,exports){
...
module.exports = HandlebarsCompiler.template({"1":function(depth0,helpers,partials,data) {
  ...
  return "  	<div class=\"form-group\">\r\n    	<label>"
    ...
    + "\" class=\"form-control col-md-3\" placeholder=\""
  ...
  var stack1, lambda=this.lambda, escapeExpression=this.escapeExpression, buffer = "\r\n<fieldset>\r\n	<legend>"
    + escapeExpression(lambda(((stack1 = (depth0 != null ? depth0.module : depth0)) != null ? stack1.className : stack1), depth0))
    + "</legend>\r\n\r\n<form class=\"form-horizontal col-md-3\" role=\"form\" name=\""
    + escapeExpression(lambda(((stack1 = (depth0 != null ? depth0.module : depth0)) != null ? stack1.className : stack1), depth0))
    + "\">\r\n";
  stack1 = helpers.each.call(depth0, depth0, {"name":"each","hash":{},"fn":this.program(1, data),"inverse":this.noop,"data":data});
  if (stack1 != null) { buffer += stack1; }
  return buffer + "  	<button class=\"btn btn-primary\" type=\"button\" data-click=\"addModel\">"
    + escapeExpression(lambda(((stack1 = (depth0 != null ? depth0.module : depth0)) != null ? stack1.addSubmitText : stack1), depth0))
    + "</button>\r\n</form>\r\n\r\n</fieldset>";
},"useData":true});
...
module.exports = HandlebarsCompiler.template({"1":function(depth0,helpers,partials,data) {
  ...
  var stack1, lambda=this.lambda, escapeExpression=this.escapeExpression, buffer = "<div class=\"modal fade\" id=\"AuteurEdit\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"myLargeModalLabel\" aria-hidden=\"true\">\r\n  <div class=\"modal-dialog modal-lg\">\r\n    <div class=\"modal-content\">\r\n\r\n	<fieldset>\r\n		<legend>"
    + escapeExpression(lambda(((stack1 = (depth0 != null ? depth0.module : depth0)) != null ? stack1.className : stack1), depth0))
    + "</legend>\r\n\r\n	<form class=\"form-horizontal col-md-3\" role=\"form\" name=\""
    + escapeExpression(lambda(((stack1 = (depth0 != null ? depth0.module : depth0)) != null ? stack1.className : stack1), depth0))
    + "\">\r\n";
  stack1 = helpers.each.call(depth0, depth0, {"name":"each","hash":{},"fn":this.program(1, data),"inverse":this.noop,"data":data});
  if (stack1 != null) { buffer += stack1; }
  return buffer + "	  	<button class=\"btn btn-primary\" type=\"button\" data-click=\"updateModel\" data-dismiss=\"modal\">"
    + escapeExpression(lambda(((stack1 = (depth0 != null ? depth0.module : depth0)) != null ? stack1.editSubmitText : stack1), depth0))
    + "</button>\r\n	</form>\r\n\r\n	</fieldset>\r\n\r\n    </div>\r\n  </div>\r\n</div>";
},"useData":true});
...
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"1":function(depth0,helpers,partials,data) {
  return "	<div class=\"alert alert-info\"> Rien a afficher </div>\r\n";
  },"3":function(depth0,helpers,partials,data) {
  var stack1, buffer = "	<table border=\"1\" bordercolor=\"#999\"  align=\"center\" cellpadding=\"0\" cellspacing=\"0\">\r\n		<tr>\r\n";
  stack1 = helpers.each.call(depth0, (depth0 != null ? depth0.thead : depth0), {"name":"each","hash":{},"fn":this.program(4, data),"inverse":this.noop,"data":data});
  if (stack1 != null) { buffer += stack1; }
  buffer += "		</tr>\r\n		\r\n";
  stack1 = helpers.each.call(depth0, (depth0 != null ? depth0.tbody : depth0), {"name":"each","hash":{},"fn":this.program(7, data),"inverse":this.noop,"data":data});
  if (stack1 != null) { buffer += stack1; }
  return buffer + "\r\n	<table/>\r\n";
},"4":function(depth0,helpers,partials,data) {
  var stack1, buffer = "";
  stack1 = helpers['if'].call(depth0, (depth0 != null ? depth0.display : depth0), {"name":"if","hash":{},"fn":this.program(5, data),"inverse":this.noop,"data":data});
  if (stack1 != null) { buffer += stack1; }
  return buffer;
  ...
  stack1 = helpers.each.call(depth0, depth0, {"name":"each","hash":{},"fn":this.program(8, data),"inverse":this.noop,"data":data});
  if (stack1 != null) { buffer += stack1; }
  buffer += "\r\n				\r\n				";
  stack1 = helpers['if'].call(depth0, (depth0 != null ? depth0.id : depth0), {"name":"if","hash":{},"fn":this.program(11, data),"inverse":this.noop,"data":data});
  if (stack1 != null) { buffer += stack1; }
  return buffer + "			</tr>\r\n";
},"8":function(depth0,helpers,partials,data) {
  var stack1, buffer = " ";
  stack1 = helpers['if'].call(depth0, (depth0 != null ? depth0.display : depth0), {"name":"if","hash":{},"fn":this.program(9, data),"inverse":this.noop,"data":data});
  if (stack1 != null) { buffer += stack1; }
  return buffer + " ";
  ...
  var helper, functionType="function", helperMissing=helpers.helperMissing, escapeExpression=this.escapeExpression;
  return " \r\n				<td>\r\n				<a data-click=\"editModel\" data-id=\""
    + escapeExpression(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : helperMissing),(typeof helper === functionType ? helper.call(depth0, {"name":"id","hash":{},"data":data}) : helper)))
    + "\" data-toggle=\"modal\" data-target=\"#AuteurEdit\" href=\"#\" style=\"margin-right:10px;\"><span class=\"glyphicon glyphicon-pencil\"></span> edit</a>\r\n				<a data-click=\"deleteModel\" data-id=\""
    + escapeExpression(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : helperMissing),(typeof helper === functionType ? helper.call(depth0, {"name":"id","hash":{},"data":data}) : helper)))
    + "\" href=\"#\"><span style=\"color:red;\" class=\"glyphicon glyphicon-remove\"></span> delete</a>\r\n				</td> \r\n";
},"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
  var stack1;
...
module.exports = HandlebarsCompiler.template({"1":function(depth0,helpers,partials,data) {
  ...
  return "	<label>"
    ...
    + escapeExpression(lambda((depth0 != null ? depth0.type : depth0), depth0))
    + "\" data-keyup=\"searchModel\" placeholder=\""
    + escapeExpression(lambda((depth0 != null ? depth0.placeholder : depth0), depth0))
    + "\" name=\""
    + escapeExpression(lambda((depth0 != null ? depth0.name : depth0), depth0))
    + "\"/>\r\n	<select name=\"\" data-change=\"searchModel\">\r\n		<option value=\"caroLe\">caroLe</option>\r\n		<option value=\"Jona\">Jona</option>\r\n		<option value=\"tes\">tes</option>\r\n	</select>\r\n";
},"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
  var stack1;
  stack1 = helpers.each.call(depth0, depth0, {"name":"each","hash":{},"fn":this.program(1, data),"inverse":this.noop,"data":data});
  if (stack1 != null) { return stack1; }
...
},{"./handlebars.runtime":32,"./handlebars/compiler/ast":34,"./handlebars/compiler/base":35,"./handlebars/compiler/compiler":36,"./handlebars/compiler/javascript-compiler":38}],32:[function(require,module,exports){
"use strict";
/*globals Handlebars: true */
...
exports["default"] = Handlebars;
},{"./handlebars/base":33,"./handlebars/exception":42,"./handlebars/runtime":43,"./handlebars/safe-string":44,"./handlebars/utils":45}],33:[function(require,module,exports){
"use strict";
...
},{"./exception":42,"./utils":45}],34:[function(require,module,exports){
"use strict";
var Exception = require("../exception")["default"];
...
exports.parse = parse;
},{"../utils":45,"./ast":34,"./helpers":37,"./parser":39}],36:[function(require,module,exports){
"use strict";
var Exception = require("../exception")["default"];
...
},{"../exception":42,"../utils":45}],37:[function(require,module,exports){
"use strict";
var Exception = require("../exception")["default"];
...
},{"../exception":42}],38:[function(require,module,exports){
"use strict";
...
},{"../base":33,"../exception":42}],39:[function(require,module,exports){
"use strict";
/* jshint ignore:start */
/* istanbul ignore next */
...
},{"./visitor":41}],41:[function(require,module,exports){
"use strict";
function Visitor() {}
...
},{"./base":33,"./exception":42,"./utils":45}],44:[function(require,module,exports){
"use strict";
...
},{"../dist/cjs/handlebars":31,"../dist/cjs/handlebars/compiler/printer":40,"../dist/cjs/handlebars/compiler/visitor":41,"fs":30}],47:[function(require,module,exports){
// Create a simple path alias to allow browserify to resolve
// the runtime on a supported path.
module.exports = require('./dist/cjs/handlebars.runtime');

},{"./dist/cjs/handlebars.runtime":32}],48:[function(require,module,exports){
